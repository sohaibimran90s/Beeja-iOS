            ...
            if sucess {
                ...
                if let _ = result["success"] as? Bool {
                    ...
                    if let result = result["result"] as? [[String:Any]] {
                        ...
                        self.guidedModel = self.decoderFunc(json: result)!
                        
                        print("guidedModel.name*** \(self.guidedModel?.name) guidedModel.meditation_list*** \(self.guidedModel?.meditation_list)")
