//
//  WWMWisdomAnimateContentView.swift
//  Meditation
//
...
class WisdomAnimateContentView: ESTabBarItemContentView {
...
class WWMWisdomAnimateContentView: WisdomAnimateContentView {
    let lottieView: AnimationView = {
        let lottieView = AnimationView(name: "leaf")
