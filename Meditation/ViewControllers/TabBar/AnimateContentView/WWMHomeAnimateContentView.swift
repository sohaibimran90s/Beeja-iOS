//
//  WWMHomeAnimateContentView.swift
//  Meditation
//
...
class HomeAnimateContentView: ESTabBarItemContentView {
...
class WWMHomeAnimateContentView: HomeAnimateContentView {
    let lottieView: AnimationView = {
        let lottieView = AnimationView(name: "home")
