//
//  WWMProgressAnimateContentView.swift
//  Meditation
//
...
class ProgressAnimateContentView: ESTabBarItemContentView {
...
class WWMProgressAnimateContentView: ProgressAnimateContentView {
    let lottieView: AnimationView = {
        let lottieView = AnimationView(name: "graph")
