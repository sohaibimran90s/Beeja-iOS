//
//  WWMGuideAnimateContentView.swift
//  Meditation
//
...
class GuideAnimateContentView: ESTabBarItemContentView {
...
class WWMGuideAnimateContentView: GuideAnimateContentView {
    let lottieView: AnimationView = {
        let lottieView = AnimationView(name: "guide-inactive")
